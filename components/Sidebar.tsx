...
const Sidebar = () => {
  ...
  return (
    <>
      <Image
        src="https://resumev3.netlify.app/static/media/profile.b3e5cc56672c4d475216.png"
        alt="avatar"
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider">
        <span className="text-green ">Ferdinand</span> Estoque
      </h3>
      ...
      >
        <div className="flex items-center justify-center">
          <GoLocation className="mr-2" /> <span>Cavite, Philippines</span>
        </div>
        <p className="my-2 ">ferdinand.estoque@yahoo.com </p>
        <p className="my-2">+639958143127</p>
      </div>
